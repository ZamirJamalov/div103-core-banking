 ...
 (p_customer_id number, p_deposit_product_id number, p_contract_no varchar2,
  ...
  begin
       insert into cb_customer_deposits 
        (customer_id,deposit_product_id,contract_no,deposit_amount,
         profit_amount,start_date) 
         values
         (p_customer_id,p_deposit_product_id,p_contract_no,p_deposit_amount,
         p_profit_amount,p_start_date);
        commit; 
  end;
